...
return array(
    ...
    'components' => array(
        ...
        'user' => array(
			...
			'identityCookie'=>array('domain' => '.sysu.edu.cn','path' => '/'),//配置用户cookie作用域  
	        'stateKeyPrefix'=>'mis',//你的前缀，必须指定为一样的  
		//	'loginUrl'=>array('/site/login'),  
        ),


        'session' => array(  
			'cookieParams' => array('domain' => '.sysu.edu.cn', 'lifetime' => 0),//配置会话ID作用域 生命期和超时  
			'timeout' => 3600,  
